...
@section('title', 'Gallery/Video Upload')
@section('breadcrumbTitle', 'Gallery/Video Upload')
@section('breadcrumbSubTitle', 'Gallery/Video Upload')
    ...
    var table = $('#example').DataTable({
        ...
        columns: [{
            ...
            },
            {
                data: null,
                render: data => {
                    return `<span class='text-capitalize'>${data.type}</span>`;
                }
            },
            {
                data: null,
