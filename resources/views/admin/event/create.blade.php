                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-2">
                            <div class="form-group ImageBackground text-center">
                                ...
                                <input type="file" id="image" name="logo" class="form-control shadow-none" onchange="document.querySelector('.imageShow').src = window.URL.createObjectURL(this.files[0])" />
                            </div>
                        </div>
                    </div>
                </form>
