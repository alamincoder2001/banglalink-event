...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-9 p-0 position-relative">
					<!-- header-bottom - start -->
					<div class="header-bottom position-absolute px-2 py-3" style="z-index: 999;">
						<div class="site-logo-wrapper">
							<a href="index-1.html" class="logo">
								<img src="{{asset('frontend')}}/assets/images/1.site-logo.png" alt="logo_not_found">
							</a>
						</div>
					</div>
					<!-- header-bottom - end -->
					...
					<div class="tab-wrapper">
						<div class="tab-menu">
							<ul class="nav tab-nav mb-25">
								<li class="nav-item">
									<a class="nav-link" id="nav-one-tab" data-toggle="tab" href="#nav-one" aria-expanded="true">
										...
										<span class="title">
											<strong class="yellow-color">5 <i class="fas fa-star"></i> Chocolato
											</strong>
											Hotel
										</span>
								...
								<li class="nav-item">
									<a class="nav-link" id="nav-two-tab" data-toggle="tab" href="#nav-two" aria-expanded="false">
										...
										<span class="title">
											<strong class="yellow-color">4 <i class="fas fa-star"></i> Vanila
											</strong>
											Hotel
										</span>
										<small class="sub-title">Party Room 2.500 seats</small>
								...
								<li class="nav-item">
									<a class="nav-link" id="nav-three-tab" data-toggle="tab" href="#nav-three" aria-expanded="false">
										...
										<span class="title">
											<strong class="yellow-color">3 <i class="fas fa-star"></i> Pear
											</strong>
											Hotel
										</span>
										<small class="sub-title">Party Room 2.500 seats</small>
								...
								<li class="nav-item">
									<a class="nav-link" id="nav-five-tab" data-toggle="tab" href="#nav-five" aria-expanded="false">
										<span class="image">
											<img src="{{asset('frontend')}}/assets/images/conference/conference-room-with-projection-facilities-3d-model-max.jpg" alt="Image_not_found">
										</span>
										<span class="title">
											<strong class="yellow-color">4 <i class="fas fa-star"></i> Vanila
											</strong>
							...
							<div class="text-center">
								<a href="#!">
									<strong class="yellow-color">VIEW ALL</strong>
								</a>
							</div>
						</div>
					</div>
		...
		<div class="sidebar-menu-wrapper">
			<div id="sidebar" class="sidebar">
				...
				<div class="sidebar-header">
					<a href="#!">
						<img src="{{asset('frontend')}}/assets/images/2.site-logo.png" alt="logo_not_found">
					</a>
				</div>
				...
				<div class="login-btn-group">
					<ul>
						...
						<li>
							...
							<div id="alt-register-modal" class="reglog-modal-wrapper register-modal mfp-hide clearfix" style="background-image: url({{asset('frontend')}}/assets/images/login-modal-bg.jpg);">
								<div class="overlay-black clearfix">
									...
									<div class="leftside-content">
										...
										<div class="copyright-text">
											<p class="m-0">©2019 <a href="#!" class="yellow-color">Harmoni.com</a> all
												right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio
											</p>
										</div>
									</div>
											...
											<form action="#!">
												...
												<div class="human-verification text-left">
													...
													<span class="verification-image">
														<img src="{{asset('frontend')}}/assets/images/iamnotrobot.png" alt="Image_not_found">
													</span>
												</div>
						...
						<li>
							...
							<div id="alt-login-modal" class="reglog-modal-wrapper mfp-hide clearfix" style="background-image: url({{asset('frontend')}}/assets/images/login-modal-bg.jpg);">
								<div class="overlay-black clearfix">
									...
									<div class="leftside-content">
										...
										<div class="copyright-text">
											<p class="m-0">©2018 <a href="#!" class="yellow-color">Harmoni.com</a> all
												right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio
											</p>
										</div>
									</div>
	...
	<!-- special-offer-section - start
		================================================== -->
	<section id="special-offer-section" class="special-offer-section clearfix" style="background-image: url({{asset('frontend')}}/assets/images/special-offer-bg.png);">
		<div class="container">
			<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="event-item clearfix">
								...
								<div class="event-image">
									...
									<img src="{{asset('frontend')}}/assets/images/event/event-2.jpg" alt="Image_not_found">
								</div>
								<!-- event-image - end -->
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="event-item clearfix">
								...
								<div class="event-image">
									...
									<img src="{{asset('frontend')}}/assets/images/event/event-3.jpg" alt="Image_not_found">
								</div>
								<!-- event-image - end -->
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="event-item clearfix">
								...
								<div class="event-image">
									...
									<img src="{{asset('frontend')}}/assets/images/event/event-4.jpg" alt="Image_not_found">
								</div>
								<!-- event-image - end -->
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="event-item clearfix">
								...
								<div class="event-image">
									...
									<img src="{{asset('frontend')}}/assets/images/event/event-5.jpg" alt="Image_not_found">
								</div>
								<!-- event-image - end -->
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="event-item clearfix">
								...
								<div class="event-image">
									...
									<img src="{{asset('frontend')}}/assets/images/event/event-6.jpg" alt="Image_not_found">
								</div>
								<!-- event-image - end -->
		...
		<div class="container">
			...
			<div id="event-expertise-carousel" class="event-expertise-carousel owl-carousel owl-theme">
				...
				<div class="item">
					...
					<div class="expertise-item">
						<div class="image image-wrapper">
							<img src="{{asset('frontend')}}/assets/images/experties/img1.jpg" alt="Image_not_found">
				...
				<div class="item">
					...
					<div class="expertise-item">
						<div class="image image-wrapper">
							<img src="{{asset('frontend')}}/assets/images/experties/img2.jpg" alt="Image_not_found">
							<a href="#!" class="plus-effect"></a>
						</div>
						<div class="content">
				...
				<div class="item">
					...
					<div class="expertise-item">
						<div class="image image-wrapper">
							<img src="{{asset('frontend')}}/assets/images/experties/img3.jpg" alt="Image_not_found">
							<a href="#!" class="plus-effect"></a>
						</div>
						<div class="content">
	...
	<section id="speaker-section" class="speaker-section clearfix">
		<div class="jarallax" style="background-image: url({{asset('frontend')}}/assets/images/speaker/Black-White-Dubai-Wallpaper.jpg);">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-12 col-sm-12">
										<div class="speaker-image image-wrapper text-center">
											<img src="{{asset('frontend')}}/assets/images/speaker/speakes1.png" alt="Image_not_found">
										...
										<div class="speaker-content">
											...
											<div class="speaker-info">
												<div class="speaker-title mb-30">
													<span class="speaker-name"><strong>Jenni</strong> Berthas</span>
													<span class="work-experienc yellow-color"><strong>15 Years</strong>
														experienced</span>
												</div>
							...
							<div class="item">
								<div class="item-content">
									<span class="speaker-thumbnail">
										<img src="{{asset('frontend')}}/assets/images/speaker/speakes-thumbnail.png" alt="Image_not_found">
									</span>
	...
	<!-- advertisement-section - start
		================================================== -->
	<section id="advertisement-section" class="advertisement-section clearfix" style="background-image: url({{asset('frontend')}}/assets/images/special-offer-bg.png);">
		<div class="container">
		...
		<div class="container">
			...
			<div class="section-title text-center mb-50">
				...
				<p class="m-0 black-color">
					...
					tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer adipiscing elit.
				</p>
			</div>
			<!-- section-title - end -->
			...
			<div class="row">
						...
						<div id="partners-carousel" class="partners-carousel owl-carousel owl-theme">
							...
							<div class="item">
								<ul>
									...
									<li>
										<a href="#!">
											<img src="{{asset('frontend')}}/assets/images/partners/image1.png" alt="Image_not_found">
										</a>
									</li>
									<li>
										<a href="#!">
				...
				<div class="col-lg-6 col-md-12 col-sm-12">
					<div class="clients-testimonial" style="background-image: url({{asset('frontend')}}/assets/images/1.testimonial-bg.jpg);">
						<div class="overlay-black">
							...
							<div id="clients-testimonial-carousel" class="clients-testimonial-carousel owl-carousel owl-theme">
								<div class="item text-center">
									<p class="mb-30">
										“Bring people together, or turn your passion into a business. Harmoni gives you
										everything you need to host your best event yet. lorem ipsum diamet adispiscing
										dispend.”
									</p>
					...
					<div class="latest-blog-wrapper">
						...
						<div class="latest-blog clearfix">
							<div class="blog-image">
								<img src="{{asset('frontend')}}/assets/images/blog/1.latest-blog.jpg" alt="Image_not_found">
								<a href="#!" class="plus-effect"></a>
							</div>
							<div class="blog-content">
								...
								<p class="m-0">
									Harmoni gives you everything you need to host your best event yet. lorem ipsum
									diamet.
								</p>
							</div>
						</div>
						...
						<div class="instagram-wrapper ul-li">
							...
							<ul>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img1.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img2.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img3.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img4.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img5.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
								<li class="image-wrapper">
									<img src="{{asset('frontend')}}/assets/images/footer/instagram/img6.png" alt="Image_not_found">
									<a href="#!"><i class="fab fa-instagram"></i></a>
								</li>
							</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="copyright-text">
							<p class="m-0">©2018 <a href="#!" class="site-link">Harmoni.com</a> all right reserved, made
